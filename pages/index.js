...
export default function Home() {
  return (
    <>
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-10 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Notus NextJS - Una extensión de Tailwind CSS.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                ...
                components for ReactJS, Vue and Angular, and Next xd.
              </p>
              <div className="mt-12">
                <a
      ...
      <section className="mt-12 md:mt-10 pb-10 relative bg-blueGray-100">
        <div
        ...
        <div className="container mx-auto overflow-hidden pb-20">
          ...
          <div className="flex flex-wrap items-center pt-10">
            <div className="w-full md:w-6/12 px-4 mr-auto ml-auto mt-10">
      ...
      <section className="py-20 bg-blueGray-600 overflow-hidden">
        <div className="container mx-auto pb-10">
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-10">
              <div className="text-blueGray-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
            ...
            <div className="w-full md:w-4/12 px-4 mr-auto ml-auto mt-12 relative">
